...
def upgrade():
    ...
    op.create_index("event_type_idx", "events", ["event_type"], unique=False)
    op.create_index("event_lessee_id_idx", "events", ["lessee_id"], unique=False)
    op.create_index("event_owner_id_idx", "events", ["owner_id"], unique=False)
    op.create_index(
        "event_resource_idx", "events", ["resource_type", "resource_uuid"], unique=False
    )
