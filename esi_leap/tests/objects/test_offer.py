...
class TestOfferObject(base.DBTestCase):
    def setUp(self):
        ...
        self.test_parent_lease_expired = lease.Lease(
            uuid=uuidutils.generate_uuid(), status=statuses.EXPIRED
        )
    ...
    def test_get_availabilities_offer_in_future(self, mock_datetime, mock_ogct):
    ...
    @mock.patch("esi_leap.db.sqlalchemy.api.offer_get_conflict_times")
    @mock.patch("esi_leap.objects.offer.datetime")
    def test_get_availabilities_conflicts_in_future(self, mock_datetime, mock_ogct):
        o = offer.Offer(self.context, **self.test_offer_data)
    ...
    @mock.patch("esi_leap.db.sqlalchemy.api.offer_get_conflict_times")
    @mock.patch("esi_leap.objects.offer.datetime")
    def test_get_availabilities_conflicts_current(self, mock_datetime, mock_ogct):
        o = offer.Offer(self.context, **self.test_offer_data)
    ...
    @mock.patch("esi_leap.db.sqlalchemy.api.offer_get_conflict_times")
    @mock.patch("esi_leap.objects.offer.datetime")
    def test_get_availabilities_conflicts_past(self, mock_datetime, mock_ogct):
        o = offer.Offer(self.context, **self.test_offer_data)
    ...
    def test_create(self, mock_oc, mock_rva):
        ...
        mock_rva.assert_called_once_with(
            o.resource_type, o.resource_uuid, o.start_time, o.end_time
        )
    ...
    def test_create_with_parent_lease(self, mock_oc, mock_lg, mock_lvca):
        o = offer.Offer(self.context, **self.test_offer_create_parent_lease_data)
        ...
        mock_oc.assert_called_once_with(self.test_offer_create_parent_lease_data)

    @mock.patch("esi_leap.db.sqlalchemy.api.lease_verify_child_availability")
    @mock.patch("esi_leap.objects.lease.Lease.get")
    @mock.patch("esi_leap.db.sqlalchemy.api.offer_create")
    def test_create_with_parent_lease_expired(self, mock_oc, mock_lg, mock_lvca):
        o = offer.Offer(self.context, **self.test_offer_create_parent_lease_data)
