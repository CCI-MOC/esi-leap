...
class TestCollection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_collection.stuff = []
        self.obj1 = mock.Mock(uuid='aaaaa')
        self.obj2 = mock.Mock(uuid='bbbbb')
        self.obj3 = mock.Mock(uuid='ccccc')
        self.test_collection.stuff.append(self.obj1)
        self.test_collection.stuff.append(self.obj2)
        self.test_collection.stuff.append(self.obj3)
        self._type = 'url'
    ...
    def test_get_next(self):
        ...
        link = ("{'key1': 'Things', 'key2': 'Stuff'}"
                "/v1/stuff?limit=3&marker=") + self.obj3.uuid
